...
Undefined is not evidence of safety.
...
This document distinguishes at least four equivalence classes.
...
### 21.2 Lineage equivalence

Two states are lineage-equivalent if they share a governed ancestor and their divergence is ledger-visible.

```text
c1 ≡lineage c2
```

Forked siblings may be lineage-equivalent without being the same active `c`.

### 21.3 Operational continuity equivalence
...
This is the primary continuity relation.

### 21.4 Resemblance equivalence

Two states are resemblance-equivalent if style/behavior matches within a declared similarity threshold.
